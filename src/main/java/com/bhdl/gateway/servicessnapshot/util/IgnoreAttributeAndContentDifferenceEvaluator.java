...
public class IgnoreAttributeAndContentDifferenceEvaluator implements DifferenceEvaluator {

    private String attributeName;

    public IgnoreAttributeAndContentDifferenceEvaluator(String attributeName) {
